...
final class MainFlowController: BaseNavigationFlowController {
    ...
    func showDropInViewController(jwt: String, handleCardinalWarnings: Bool) {
        ...
        let dropInVC = ViewControllerFactory.shared.dropInViewController(jwt: jwt, typeDescriptions: [.threeDQuery, .auth], gatewayType: .eu, username: appFoundation.keys.merchantUsername, siteReference: appFoundation.keys.merchantSiteReference, isLiveStatus: false, isDeferInit: false, dropInViewStyleManager: dropInViewStyleManager, successfulPaymentCompletion: { [unowned self] _, cardReference in
