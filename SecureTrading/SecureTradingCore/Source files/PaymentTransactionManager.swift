...
@objc public final class PaymentTransactionManager: NSObject {
    ...
    public init(jwt: String, gatewayType: GatewayType, username: String, isLiveStatus: Bool, isDeferInit: Bool, cardTypeToBypass: [CardType] = [], cardinalStyleManager: CardinalStyleManager? = nil) {
        self.jwt = jwt
        ...
        self.threeDSecureManager = ST3DSecureManager(isLiveStatus: self.isLiveStatus, cardinalStyleManager: cardinalStyleManager)
