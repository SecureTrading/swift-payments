...
@objc public class DropInViewStyleManager: NSObject {
    ...
    @objc public init(inputViewStyleManager: InputViewStyleManager?, requestButtonStyleManager: RequestButtonStyleManager?, backgroundColor: UIColor?, spacingBeetwenInputViews: CGFloat = 30, insets: UIEdgeInsets = UIEdgeInsets(top: 15, left: 30, bottom: -15, right: -30)) {
