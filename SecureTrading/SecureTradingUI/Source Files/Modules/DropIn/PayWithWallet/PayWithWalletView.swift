//
//  PayWithWalletView.swift
//  SecureTradingUI
//

import UIKit
class CardReferenceView: BaseView {
    let pan: String
    var label: UILabel!
...
@objc public final class PayWithWalletView: BaseView {
    ...
    private lazy var stackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [cvcInput, payButton])
...
extension PayWithWalletView: ViewSetupable {
...
extension PayWithWalletView: CardNumberInputViewDelegate {
